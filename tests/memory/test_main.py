...
from wolf-logic.memory.main import AsyncMemory, Memory
...
def _setup_mocks(mocker):
    ...
    mocker.patch("wolf-logic.utils.factory.EmbedderFactory.create", mock_embedder)

    mock_vector_store = mocker.MagicMock()
    mock_vector_store.return_value.search.return_value = []
    mocker.patch(
        "wolf-logic.utils.factory.VectorStoreFactory.create", side_effect=[mock_vector_store.return_value, mocker.MagicMock()]
    )

    mock_llm = mocker.MagicMock()
    mocker.patch("wolf-logic.utils.factory.LlmFactory.create", mock_llm)

    mocker.patch("wolf-logic.memory.storage.SQLiteManager", mocker.MagicMock())
...
class TestAddToVectorStoreErrors:
    ...
    def test_empty_llm_response_fact_extraction(self, mocker, mock_memory, caplog):
        ...
        mocker.patch("wolf-logic.memory.main.capture_event", mock_capture_event)
...
class TestAsyncAddToVectorStoreErrors:
    ...
    async def test_async_empty_llm_response_fact_extraction(self, mock_async_memory, caplog, mocker):
        ...
        mocker.patch("wolf-logic.utils.factory.EmbedderFactory.create", return_value=MagicMock())
