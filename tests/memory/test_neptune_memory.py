...
import pytest
from wolf-logic.graphs.neptune.neptunedb import MemoryGraph
from wolf-logic.graphs.neptune.base import NeptuneBase
...
class TestNeptuneMemory(unittest.TestCase):
    ...
    def setUp(self):
        ...
        self.config.llm.provider = "ollama_structured"
        ...
        self.neptune_graph_patcher = patch("wolf-logic.graphs.neptune.neptunedb.NeptuneGraph")
    ...
    def test_initialization(self):
        ...
        self.assertEqual(self.memory_graph.llm_provider, "ollama_structured")
    ...
    def test_collection_name_variants(self):
        ...
        MemoryGraph(config3)
        self.assertEqual(config3.vector_store.config.collection_name, "wolf-logic_neptune_vector_store")
    ...
    def test_search_method(self):
        ...
        # Mock BM25Okapi
        with patch("wolf-logic.graphs.neptune.base.BM25Okapi") as mock_bm25:
