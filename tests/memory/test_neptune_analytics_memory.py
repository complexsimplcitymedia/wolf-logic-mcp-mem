...
import pytest
from wolf-logic.graphs.neptune.neptunegraph import MemoryGraph
...
class TestNeptuneMemory(unittest.TestCase):
    ...
    def setUp(self):
        ...
        self.neptune_analytics_graph_patcher = patch("wolf-logic.graphs.neptune.neptunegraph.NeptuneAnalyticsGraph")
