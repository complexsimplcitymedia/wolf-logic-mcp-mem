...
from wolf-logic.embeddings.vertexai import VertexAIEmbedding


@pytest.fixture
def mock_text_embedding_model():
    with patch("wolf-logic.embeddings.vertexai.TextEmbeddingModel") as mock_model:
        mock_instance = Mock()
...
@pytest.fixture
def mock_os_environ():
    with patch("wolf-logic.embeddings.vertexai.os.environ", {}) as mock_environ:
        yield mock_environ


@pytest.fixture
def mock_config():
    with patch("wolf-logic.configs.embeddings.base.BaseEmbedderConfig") as mock_config:
...
def mock_text_embedding_input():
    with patch("wolf-logic.embeddings.vertexai.TextEmbeddingInput") as mock_input:
        yield mock_input


@patch("wolf-logic.embeddings.vertexai.TextEmbeddingModel")
...
@patch("wolf-logic.embeddings.vertexai.os")
