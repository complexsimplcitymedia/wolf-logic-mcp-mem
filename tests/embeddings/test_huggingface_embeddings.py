...
from wolf-logic.embeddings.huggingface import HuggingFaceEmbedding


@pytest.fixture
def mock_sentence_transformer():
    with patch("wolf-logic.embeddings.huggingface.SentenceTransformer") as mock_transformer:
        mock_model = Mock()
