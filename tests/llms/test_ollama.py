...
from wolf-logic.configs.llms.ollama import OllamaConfig
from wolf-logic.llms.ollama import OllamaLLM


@pytest.fixture
def mock_ollama_client():
    with patch("wolf-logic.llms.ollama.Client") as mock_ollama:
        mock_client = Mock()
