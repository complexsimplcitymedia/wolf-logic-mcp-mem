...
from wolf-logic.configs.llms.deepseek import DeepSeekConfig
from wolf-logic.llms.deepseek import DeepSeekLLM


@pytest.fixture
def mock_deepseek_client():
    with patch("wolf-logic.llms.deepseek.OpenAI") as mock_ollama:
        mock_client = Mock()
