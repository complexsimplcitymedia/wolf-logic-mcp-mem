...
@patch('wolf-logic.utils.factory.EmbedderFactory.create')
@patch('wolf-logic.utils.factory.VectorStoreFactory.create')
@patch('wolf-logic.utils.factory.LlmFactory.create')
@patch('wolf-logic.memory.storage.SQLiteManager')
def test_collection_name_preserved_after_reset(mock_sqlite, mock_llm_factory, mock_vector_factory, mock_embedder_factory):
    ...
    test_collection_name = "wolf-logic"
    config = MemoryConfig()
...
def test_search_handles_incomplete_payloads(mock_sqlite, mock_llm_factory, mock_vector_factory, mock_embedder_factory):
    ...
    from wolf-logic.memory.main import Memory as MemoryClass
    config = MemoryConfig()
