...
from wolf-logic.vector_stores.valkey import ValkeyDB
...
def test_insert(valkey_db, mock_valkey_client):
    ...
    assert args[0] == "wolf-logic:test_collection:test_id"
...
def test_delete(valkey_db, mock_valkey_client):
    ...
    mock_valkey_client.delete.assert_called_once_with("wolf-logic:test_collection:test_id")
...
def test_get(valkey_db, mock_valkey_client):
    ...
    mock_valkey_client.hgetall.assert_called_once_with("wolf-logic:test_collection:test_id")
