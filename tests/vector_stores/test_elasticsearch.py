...
from wolf-logic.vector_stores.elasticsearch import ElasticsearchDB, OutputData
from wolf-logic.configs.vector_stores.elasticsearch import ElasticsearchConfig
...
class TestElasticsearchDB(unittest.TestCase):
    ...
    def setUp(self):
        ...
        patcher = patch("wolf-logic.vector_stores.elasticsearch.Elasticsearch", return_value=self.client_mock)
    ...
    def test_insert(self):
        ...
        # Mock bulk operation
        with patch("wolf-logic.vector_stores.elasticsearch.bulk") as mock_bulk:
    ...
    def test_es_valid_headers(self):
        config = {
            ...
            "user": "elastic",
            "password": "password",
            "headers": {"x-extra-info": "my-wolf-logic-instance"},
        }
        es_config = ElasticsearchConfig(**config)
        self.assertIsNotNone(es_config.headers)
        self.assertEqual(len(es_config.headers), 1)
        self.assertEqual(es_config.headers["x-extra-info"], "my-wolf-logic-instance")
