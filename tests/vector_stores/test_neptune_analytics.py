...
from wolf-logic.utils.factory import VectorStoreFactory

load_dotenv()

# Configure logging
logging.getLogger("wolf-logic.vector.neptune.main").setLevel(logging.INFO)
logging.getLogger("wolf-logic.vector.neptune.base").setLevel(logging.INFO)
