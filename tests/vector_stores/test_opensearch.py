...
from wolf-logic.vector_stores.opensearch import OpenSearchDB
...
class TestOpenSearchDB(unittest.TestCase):
    ...
    def setUp(self):
        ...
        patcher = patch("wolf-logic.vector_stores.opensearch.OpenSearch", return_value=self.client_mock)
    ...
    def test_init_with_http_auth(self):
        ...
        with patch("wolf-logic.vector_stores.opensearch.OpenSearch") as mock_opensearch:
            OpenSearchDB(
                host="localhost",
                port=9200,
                collection_name="test_collection",
