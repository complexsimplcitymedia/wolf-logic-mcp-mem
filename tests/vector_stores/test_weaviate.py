...
from wolf-logic.vector_stores.weaviate import Weaviate
...
class TestWeaviateDB(unittest.TestCase):
    ...
    def setUp(self):
        ...
        patcher = patch("wolf-logic.vector_stores.weaviate.weaviate.connect_to_local", return_value=self.client_mock)
