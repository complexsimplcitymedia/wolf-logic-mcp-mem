...
from wolf-logic.vector_stores.azure_mysql import AzureMySQL, OutputData
...
def azure_mysql_instance(mock_connection_pool):
    ...
    with patch('wolf-logic.vector_stores.azure_mysql.PooledDB') as mock_pooled_db:
...
def test_azure_credential_authentication():
    ...
    with patch('wolf-logic.vector_stores.azure_mysql.DefaultAzureCredential') as mock_cred:
        mock_token = Mock()
