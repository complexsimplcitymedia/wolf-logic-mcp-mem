...
from wolf-logic.vector_stores.pgvector import PGVector
...
class TestPGVector(unittest.TestCase):
    ...
    @patch('wolf-logic.vector_stores.pgvector.PSYCOPG_VERSION', 3)
    @patch('wolf-logic.vector_stores.pgvector.ConnectionPool')
    ...
    @patch('wolf-logic.vector_stores.pgvector.PSYCOPG_VERSION', 2)
    @patch('wolf-logic.vector_stores.pgvector.ConnectionPool')
    ...
    def test_insert_psycopg2(self, mock_get_cursor, mock_connection_pool):
        ...
        with patch.dict('sys.modules', {
            ...
            if 'wolf-logic.vector_stores.pgvector' in sys.modules:
                importlib.reload(sys.modules['wolf-logic.vector_stores.pgvector'])
    ...
    @patch('wolf-logic.vector_stores.pgvector.ConnectionPool')
    @patch.object(PGVector, '_get_cursor')
    @patch('wolf-logic.vector_stores.pgvector.Json')
    ...
    def test_pool_cleanup_psycopg3(self):
        ...
        with patch('wolf-logic.vector_stores.pgvector.PSYCOPG_VERSION', 3), \
             patch('wolf-logic.vector_stores.pgvector.ConnectionPool') as mock_connection_pool:
    ...
    def test_pool_cleanup_psycopg2(self):
        ...
        with patch('wolf-logic.vector_stores.pgvector.PSYCOPG_VERSION', 2), \
             patch('wolf-logic.vector_stores.pgvector.ConnectionPool') as mock_connection_pool:
