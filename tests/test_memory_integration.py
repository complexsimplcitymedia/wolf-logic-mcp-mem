...
def test_azure_config_structure():
        ...
        "llm": {
            ...
            "config": {
                ...
                "azure_kwargs": {
                    ...
                    "azure_endpoint": "https://test.ollama.azure.com/",
                    "api_key": "test-key",
                },
            },
        },
    ...
    assert azure_config["llm"]["provider"] == "azure_ollama"
    ...
    assert azure_config["embedder"]["provider"] == "azure_ollama"
